export const TALIdentityRegistryABI = [
  ...
  {
    "type": "error",
    "name": "CapabilityAlreadyVerified",
    "inputs": [
      {
        "name": "agentId",
        "type": "uint256",
