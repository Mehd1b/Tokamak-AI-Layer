//! RISC Zero zkVM Guest Entry Point (perp-trader)
//!
//! This is a wrapper that delegates to the perp-trader agent crate for zkVM execution.
...
fn main() {
    ...
    match perp_trader::kernel_main(&input_bytes) {
        Ok(journal_bytes) => {
