...
interface IBondManager {
    ...
    function lockBondBatch(address[] calldata vaults, uint64[] calldata nonces, uint256[] calldata amounts) external;
    ...
    function getBondInfo(address operator, address vault, uint64 nonce) external view returns (uint256 amount, uint256 lockedAt, uint8 status);
}
