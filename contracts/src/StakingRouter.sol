...
contract StakingRouter is ReentrancyGuard {
    ...
    /// @dev Emit the Staked event with the TON-equivalent of the
    ...
    function stakeFromWTON(uint256 wtonAmount) external nonReentrant {
        ...
        // WTON is 27 decimals, TON is 18 decimals → scale down by 1e9.
    ...
    /// @dev Previously this function pulled WSTON from the user and
