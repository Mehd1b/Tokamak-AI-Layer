      ...
      for (let col = 0; col < cols; col++) {
        for (let row = 0; row < rows; row++) {
          ...
          if (value > threshold) {
            ...
            // Purple/violet color scheme matching the frontend theme
            const colorT = Math.min(1, Math.max(0, (value + 0.3)));
            const r = Math.floor(80 + colorT * 88);   // 80-168
            const g = Math.floor(20 + colorT * 65);    // 20-85
            const b = Math.floor(140 + colorT * 107);  // 140-247
