...
export function Navbar() {
  ...
  return (
    <>
      <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 py-4 sm:px-8 backdrop-blur-sm bg-[#0a0a0f]/40 border-b border-white/5">
