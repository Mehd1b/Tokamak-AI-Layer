...
export function Footer() {
  ...
  return (
    <footer ref={footerRef} className="relative z-10 bg-[#0a0a0f]">
      {/* Top gradient line */}
      <div className="h-[1px] bg-gradient-to-r from-transparent via-[#38BDF8]/30 to-transparent" />

      {/* Glow effect at top */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-1/3 h-[2px] bg-gradient-to-r from-transparent via-[#38BDF8]/50 to-transparent blur-sm" />
          ...
          <div className="flex flex-col items-center space-y-10">
            ...
            <div className={`text-center transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
              <div className="flex items-center justify-center gap-3 mb-3">
                ...
                <div className="relative w-10 h-10">
                  <svg viewBox="0 0 40 40" className="w-full h-full">
                    <circle cx="20" cy="20" r="16" fill="none" stroke="#38BDF8" strokeWidth="1" strokeDasharray="4 4" strokeOpacity="0.5" />
                    <circle cx="20" cy="20" r="10" fill="none" stroke="#38BDF8" strokeWidth="1" strokeOpacity="0.8" />
                    <circle cx="20" cy="20" r="3" fill="#38BDF8" style={{ filter: 'drop-shadow(0 0 4px #38BDF8)' }} />
                  </svg>
                </div>
                <span
              ...
              <p
                ...
                style={{ fontFamily: 'var(--font-mono), monospace' }}
              >
                ERC-8004 Compliant Agent Registry on Tokamak Network
              </p>
            </div>
            ...
            <div className={`flex flex-col sm:flex-row items-center gap-2 text-gray-600 text-xs transition-all duration-700 delay-400 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
              <span style={{ fontFamily: 'var(--font-mono), monospace' }}>
                &copy; {new Date().getFullYear()} Tokamak Agent Layer
              </span>
