      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-2 mb-1">
            {isPinned && (
              <span className="flex items-center gap-1 text-[#c4f547] text-xs font-mono">
            ...
            <span className="text-[#d5f972] text-sm font-mono">
          ...
          <div className="flex items-center gap-3 mt-2 opacity-0 group-hover:opacity-100 transition-opacity">
            <button
              ...
              className="text-gray-500 text-xs hover:text-[#d5f972] transition-colors"
            >
              Reply
            </button>
            {isVaultOwner && !isPinned && onPin && (
              <button
                ...
                className="text-gray-500 text-xs hover:text-[#c4f547] transition-colors"
              >
                Pin
              </button>
            )}
