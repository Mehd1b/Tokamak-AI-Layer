...
export class LendingBuilder {
    ...
    buildLeveragedLong(config) {
        const { collateralToken, targetToken, stablecoin, collateralAmount, leverageMultiplier, recipient, poolFee, } = config;
        const txs = [];
    ...
    buildSpotShort(config) {
        const { targetToken, stablecoin, collateralAmount, borrowAmount, recipient, poolFee, } = config;
        const txs = [];
    ...
    buildClosePosition(config) {
        const { direction, collateralToken, debtToken, repayAmount, withdrawAmount, recipient, poolFee, } = config;
        const txs = [];
        if (direction === "long") {
...
//# sourceMappingURL=LendingBuilder.js.map