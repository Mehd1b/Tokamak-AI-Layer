...
function resolveTokens(symbolList: string): Address[] {
...
async function main(): Promise<void> {
  ...
  const barInterval = (args["interval"] ?? "1d") as "1h" | "4h" | "1d";
  ...
  const quoteToken = (getTokenBySymbol("USDC")?.address ?? "0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48") as Address;
